...
def add_village(server, account, name, coord_x="", coord_y="", population="",
...
class VillageBuildingsView(tk.Frame):
    ...
    def __init__(self, master, server, account, village_name, tribe, is_archived=False):
        ...
        self._progress_bars     = {}   # slot_id -> canvas bar
        self._cur_combos        = {}   # slot_id -> combo widget
        self._planned_levels    = {}   # slot_id -> int
        self._UNIQUE            = load_unique_buildings()
...
class MainApp(tk.Frame):
    ...
    def _refresh_village_list(self):
        ...
        for v in self.villages:
            ...
            self.village_listbox.insert(tk.END, f"      ({x} | {y})")
